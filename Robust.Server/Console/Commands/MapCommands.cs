...
namespace Robust.Server.Console.Commands
{
    public sealed class SaveGridCommand : LocalizedCommands
    {
        ...
        public override void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            _ent.System<EntitySerializationSystem>().Save(uid, args[1]);
    ...
    public sealed class LoadGridCommand : LocalizedCommands
    {
        ...
        public override void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            _system.GetEntitySystem<EntitySerializationSystem>().TryLoadGrid(mapId, args[1], out _, opts, offset, rot);
        }
    ...
    public sealed class LoadMap : LocalizedCommands
    {
        ...
        public override void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            _system.GetEntitySystem<EntitySerializationSystem>().TryLoadMap(mapId, path, out _, opts, offset, rot);
