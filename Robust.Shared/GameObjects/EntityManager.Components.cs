...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            AddComponentInternal(uid, newComponent, true, null);
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void AddComponentInternal<T>(EntityUid uid, T component, bool skipInit, MetaDataComponent? metadata) where T : IComponent
        {
        ...
        internal void AddComponentInternalOnly<T>(EntityUid uid, T component, ComponentRegistration reg, MetaDataComponent metadata) where T : IComponent
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void CullRemovedComponents()
        {
            ...
            catch (Exception e)
            {
                ...
                DeleteComponent(uid, component, false, true, meta);
            }

            _deleteSet.Clear();
        }

        private void DeleteComponent(EntityUid entityUid, IComponent component, bool terminating, bool archetypeChange, MetaDataComponent? metadata)
        {
