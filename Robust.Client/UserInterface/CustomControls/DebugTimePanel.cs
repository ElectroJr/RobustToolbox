    ...
    public sealed class DebugTimePanel : PanelContainer
    {
        ...
        protected override void FrameUpdate(FrameEventArgs args)
        {
            ...
            _contents.TextMemory = FormatHelpers.FormatIntoMem(_textBuffer,
                $@"Paused: {_gameTiming.Paused}, CurTick: {_gameTiming.CurTick}/{_gameTiming.CurTick - 1}, CurServerTick: {_gameTiming.LastProcessedTick}, Pred: {_gameTiming.CurTick.Value - _gameTiming.LastProcessedTick.Value - 1}
