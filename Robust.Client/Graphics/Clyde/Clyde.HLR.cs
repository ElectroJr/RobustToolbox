...
namespace Robust.Client.Graphics.Clyde
{
    ...
    internal partial class Clyde
    {
        ...
        // TODO SPRITE make this a ShaderInstance property
        // Also, maybe make it margin/padding instead of scale
        // because nested shaders might grow uneccesarily large.
        /// <summary>
        ...
        /// </summary>
        internal Texture? CopyScreenTexture(IRenderTarget texture)
        {
        ...
        private void DrawEntities(Viewport viewport, Box2Rotated worldBounds, Box2 worldAABB, IEye eye)
        {
            ...
            for (var i = 0; i < _drawingSpriteList.Count; i++)
            {
                ...
                _spriteSystem.RenderSprite(_renderHandle, in entry, eye.Rotation);
            }
